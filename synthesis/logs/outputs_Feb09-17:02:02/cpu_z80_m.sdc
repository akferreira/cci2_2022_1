...
#  Created by Genus(TM) Synthesis Solution GENUS15.22 - 15.20-s024_1 on Wed Feb 09 17:22:23 -0300 2022
...
group_path -name C2C -from [list \
  ...
  [get_cells {CPU_REGS_regs_hi_data_reg[1][5]}] ] -to [list \
...
set_input_transition -min 0.003 [get_ports {DI[7]}]
set_input_transition -max 0.16 [get_ports {DI[7]}]
set_input_transition -min 0.003 [get_ports {DI[6]}]
set_input_transition -max 0.16 [get_ports {DI[6]}]
set_input_transition -min 0.003 [get_ports {DI[5]}]
set_input_transition -max 0.16 [get_ports {DI[5]}]
set_input_transition -min 0.003 [get_ports {DI[4]}]
set_input_transition -max 0.16 [get_ports {DI[4]}]
set_input_transition -min 0.003 [get_ports {DI[3]}]
set_input_transition -max 0.16 [get_ports {DI[3]}]
set_input_transition -min 0.003 [get_ports {DI[2]}]
set_input_transition -max 0.16 [get_ports {DI[2]}]
set_input_transition -min 0.003 [get_ports {DI[1]}]
set_input_transition -max 0.16 [get_ports {DI[1]}]
set_input_transition -min 0.003 [get_ports {DI[0]}]
set_input_transition -max 0.16 [get_ports {DI[0]}]
...
set_input_transition -min 0.003 [get_ports INT]
set_input_transition -max 0.16 [get_ports INT]
set_input_transition -min 0.003 [get_ports NMI]
set_input_transition -max 0.16 [get_ports NMI]
set_input_transition -min 0.003 [get_ports WAIT]
set_input_transition -max 0.16 [get_ports WAIT]
