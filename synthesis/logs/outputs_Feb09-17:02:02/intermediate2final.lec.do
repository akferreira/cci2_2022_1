...
usage -auto -elapse
set log file logs_Feb09-17:02:02/intermediate2final.lec.log -replace
tclmode
...
vpx read design -verilog -golden -lastmod -noelab \
	outputs_Feb09-17:02:02/cpu_z80_intermediate.v
} else {
...
elaborate design -golden -root cpu_z80

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Feb09-17:02:02/cpu_z80_m.v
} else {
...
elaborate design -revised -root cpu_z80
