...
#  Created by Genus(TM) Synthesis Solution GENUS15.22 - 15.20-s024_1 on Wed Feb 09 19:27:25 -0300 2022
...
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[7]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[6]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[5]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[4]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[3]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[2]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[1]}]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports {DO[0]}]
...
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports MREQ]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports IORQ]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports HALT]
set_output_delay -clock [get_clocks CLK] -add_delay -min 0.2 [get_ports M1]
