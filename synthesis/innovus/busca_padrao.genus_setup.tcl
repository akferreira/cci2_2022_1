...
if {$_cell_area_ != "53452"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 53452,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "35088"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 35088,  current net area: $_net_area_"
}
unset _net_area_
